...
parallel --memfree 80G -j 20 diamond blastp --outfmt "6 qseqid sseqid pident length slen qlen gaps evalue" -d "$db_fa_path_wo_ext".dmnd -q {} -p 1 -o "$3"/diamond_align_"$db_fa_file_wo_ext"_{/.}.tsv ::: "$2"/cds_amino_seqs*.fa*

...
find "${fa_dir}" -maxdepth 1 -name "*fa.gz" -print0 | parallel -0 --memfree 30G -j 15 --resume-failed --joblog "${fa_dir}/bakta_parallel.log" bakta --db "${bakta_db}" --threads 1 --genus 'Escherichia' --gram '-' --output {//} {}
